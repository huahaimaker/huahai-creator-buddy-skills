---
name: huahai-space-video-subtitle
...
# huahai-space-video-subtitle · 字幕
...
若有剪辑（`huahai-space-video-edit`），字幕**基于剪后视频重新转写再校对**，不能沿用原视频字幕。
...
- 上游：`huahai-space-video-edit` 的 `source_cut.mp4`，或任意成片/音频
- 下游：带字幕的成片 → `huahai-space-video-cover` 或直接发布
